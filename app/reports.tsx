          ...
          {!loadingSummary && summary && (
            <View style={styles.section}>
              ...
              {summary.entries_by_vessel.length > 0 ? (
                ...
                <View style={styles.card}>
                  <Text style={{ color: colors.textSecondary, textAlign: 'center', paddingVertical: 20, fontSize: 14 }}>
                    No sea time entries yet. Add your first entry to see vessel statistics.
                  </Text>
                </View>
              )}
            </View>
