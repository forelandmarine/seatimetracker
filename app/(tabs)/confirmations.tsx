    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          showFeedback('Error', 'Failed to reject entry: ' + errorMessage, 'error');
        }
      },
      'Reject'
    );
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { maxWidth: 340 }]}>
            <Text style={[styles.modalTitle, { fontSize: 20, marginBottom: 12, textAlign: 'center' }]}>
              {feedbackModal.title}
            </Text>
              ...
              <View style={styles.modalButtons}>
                ...
                >
                  <Text style={[styles.modalButtonText, styles.saveButtonText]}>
                    {feedbackModal.confirmLabel || 'Confirm'}
                  </Text>
                </TouchableOpacity>
              </View>
            ) : (
