...
// Hardcoded fallback ensures auth client works even if Constants is not yet hydrated.
const API_URL: string =
  Constants.expoConfig?.extra?.backendUrl ||
  "https://uukpkcag4nsq8q632k643ztvus28frfe.app.specular.dev";
const BEARER_TOKEN_KEY = "seatime_auth_token";

/**
 * Canonical token storage key used across the app.
 * Import this instead of hardcoding the string.
 */
export const AUTH_TOKEN_KEY = "seatime_auth_token";
